...
title = 'CSS Classes'
+++
# Class/Scope reference - Highlight 4 Hugo 
...
Be aware that the themes out there do not define styles for these. Define a style on your own.

If you don't these will follow the standard _Highlight.js_ fallback mechanism.
