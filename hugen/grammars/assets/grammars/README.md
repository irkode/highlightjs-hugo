...
A language grammar to highlight _{{ title $lang }}_'s templating language with [Highlight.js][].
...
> have a look at the highlight.js source Asset. Maybe that fits for you
...
from our [Releases][] and extract to `highlight.js/extra` directory. Check out the
